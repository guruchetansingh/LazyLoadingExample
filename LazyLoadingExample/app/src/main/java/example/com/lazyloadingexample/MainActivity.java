...
public class MainActivity extends Activity {
    ...
    private ArrayList<String> mUrlsList=new ArrayList<String>();
    private String[] mArrayUrls={"http://androidexample.com/media/webservice/LazyListView_images/image0.png",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for( String url:mArrayUrls)
        {
            mUrlsList.add(url);
        }
        mListView = (ListView) findViewById(R.id.list_view);
        mListView.setAdapter(new ListViewAdapter(this, mUrlsList));

        mListView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int index, long l) {

                Log.d("xx",mUrlsList.get(index));
            }
